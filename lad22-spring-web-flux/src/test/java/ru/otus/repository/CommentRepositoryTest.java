...
class CommentRepositoryTest {
	...
	private static final String TITLE_INS_COMMENT = "This is an inserted comment by bookId";
	...
	void testAddComment() {
		...
		var comments = commentRepository.findCommentsByBookId(bookId).collect(Collectors.toList()).block();
